...
//==================================
{
	...
	if (type=='free-positioning'){
		html = "<a href='"+$(this.url_node[langcode]).text()+"' target='_blank'><img src='../img/url.jpg' width='100px'><p style='text-align:center;'>"+$(this.label_node[langcode]).text()+"</p></a>";
	}
	if(type=='same')
	...
	if (this.url_node[langcode].text()=='')
			html =  "<img src='../img/link-icon.png' width='100px'><p style='text-align:center;'>"+karutaStr[LANG]['no-URL']+"</p>";
	return html;
};
